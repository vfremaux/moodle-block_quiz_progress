...
function require_jqplot_libs($libroot){
	...
	$PAGE->requires->js('/blocks/quiz_progress/js/jqplot/plugins/jqplot.highlighter.min.js', true);
	$PAGE->requires->js('/blocks/quiz_progress/js/jqplot/plugins/jqplot.canvasOverlay.min.js', true);
	$PAGE->requires->js('/blocks/quiz_progress/js/jqplot/plugins/jqplot.cursor.min.js', true);
	$PAGE->requires->js('/blocks/quiz_progress/js/jqplot/plugins/jqplot.categoryAxisRenderer.min.js', true);
	$PAGE->requires->js('/blocks/quiz_progress/js/jqplot/plugins/jqplot.pointLabels.min.js', true);
	$PAGE->requires->js('/blocks/quiz_progress/js/jqplot/plugins/jqplot.logAxisRenderer.min.js', true);
	$PAGE->requires->js('/blocks/quiz_progress/js/jqplot/plugins/jqplot.canvasTextRenderer.min.js', true);
	$PAGE->requires->js('/blocks/quiz_progress/js/jqplot/plugins/jqplot.canvasAxisTickRenderer.min.js', true);
	$PAGE->requires->js('/blocks/quiz_progress/js/jqplot/plugins/jqplot.canvasAxisLabelRenderer.min.js', true);
	$PAGE->requires->js('/blocks/quiz_progress/js/jqplot/plugins/jqplot.enhancedLegendRenderer.min.js', true);
	$PAGE->requires->js('/blocks/quiz_progress/js/jqplot/plugins/jqplot.pieRenderer.min.js', true);
	$PAGE->requires->js('/blocks/quiz_progress/js/jqplot/plugins/jqplot.donutRenderer.min.js', true);
	$jqplotloaded = true;
}
